...
/*
  Copied from https://github.com/end-4/dots-hyprland/blob/449df7f161e6435569bc7d9499b2e444dd8aa153/dots/.config/quickshell/ii/modules/common/functions/ColorUtils.qml
*/
Singleton {
    id: root
     ...
     */
    function withHueOf(color1, color2) {
     ...
     * @returns {Qt.rgba} The resulting color.
     */
    function withSaturationOf(color1, color2) {
        var c1 = Qt.color(color1);
        var c2 = Qt.color(color2);
     ...
     * @returns {Qt.rgba} The resulting color.
     */
    function withLightnessOf(color1, color2) {
        var c2 = Qt.color(color2);
     ...
     * @param {number} percentage - The mix ratio (0-1). 0 = all color1, 1 = all color2.
     * @returns {Qt.rgba} The resulting mixed color.
     */
    function mix(color1, color2, percentage = 0.5) {
        var c1 = Qt.color(color1);
        var c2 = Qt.color(color2);
        return Qt.rgba(percentage * c2.r + (1 - percentage) * c1.r, percentage * c2.g + (1 - percentage) * c1.g, percentage * c2.b + (1 - percentage) * c1.b, percentage * c2.a + (1 - percentage) * c1.a);
    }
