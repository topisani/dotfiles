...
map global files f ': connect popup krc-fzf files<ret>'                      -docstring 'List files'
map global files F ': connect popup krc-fzf files -uuu<ret>'                 -docstring 'List files (including hidden)'
map global files r ": connect popup ranger<ret>"                             -docstring 'Ranger'
map global files w ': write<ret>'                                            -docstring 'Write file' 
map global files c ": connect popup krc-fzf files %val{config}<ret>"         -docstring 'Open config dir'
...
map global buffers b ': connect popup  krc-fzf buffers<ret>'        -docstring "List Buffers" 
