...
local function with_alpha(color, alpha)
   numeric_value = math.floor(alpha * 255)
   if numeric_value < 0 then numeric_value = 0 end
   if numeric_value > 255 then numeric_value = 255 end
   return color .. string.format("%2.2x", numeric_value)
end
...
theme.big_useless_gap       = dpi(10)
theme.small_useless_gap     = dpi(0)
theme.border_width          = dpi(4)
theme.border_normal         = xrdb.background
theme.border_focus          = xrdb.color4
theme.border_marked         = xrdb.color2
theme.switcher_bg           = with_alpha(xrdb.color4, 1)
theme.switcher_border       = with_alpha(xrdb.color8, 1)
...
local wallpaper_alt_fg = xrdb.color4
