...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    Cursor { bg = c.fg, fg = c.bg }, -- Character under the cursor
    lCursor { bg = c.fg, fg = c.bg }, -- Character under the cursor when |language-mapping| is used (see 'guicursor')
    CursorIM { bg = c.fg, fg = c.bg }, -- Like Cursor, but used when in IME mode |CursorIM|
    ...
    TabLineSel { fg = c.fg3, gui = "bold" }, -- Tab pages line, active tab page label
    ...
    Whitespace { fg = c.gray.mix(c.bg, 50) }, -- "nbsp", "space", "tab" and "trail" in 'listchars'
    ...
    Special { fg = c.orange_dark }, -- (*) Any special symbol
    ...
    -- Notify
    --- Border
    NotifyERRORBorder { fg = c.error.mix(c.bg, 30), bg = c.bg },
    NotifyWARNBorder { fg = c.warning.mix(c.bg, 30), bg = c.bg },
    NotifyINFOBorder { fg = c.info.mix(c.bg, 30), bg = c.bg },
    NotifyDEBUGBorder { fg = c.comment.mix(c.bg, 30), bg = c.bg },
    NotifyTRACEBorder { fg = c.purple.mix(c.bg, 30), bg = c.bg },
    --- Icons
